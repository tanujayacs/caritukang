...
|
*/
$config['base_url'] = 'http://localhost/CariTukang/admin';

//untuk assets 
$config['assets'] = $_SERVER['DOCUMENT_ROOT']."/CariTukang/assets/";
$config['url_assets'] = 'http://localhost/CariTukang/assets/';

// $config['assets_produk'] = $_SERVER['DOCUMENT_ROOT']."/marketplace2587/assets/produk/";
// $config['url_produk'] = 'http://localhost/marketplace2587/assets/produk/';
// //slider
// $config['assets_slider'] = $_SERVER['DOCUMENT_ROOT']."/marketplace2587/assets/slider/";
// $config['url_slider'] = 'http://localhost/marketplace2587/assets/slider/';
//artikel
